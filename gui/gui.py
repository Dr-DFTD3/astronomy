...
class mainWindow(Gtk.Window):
    ...
    def __init__(self):
        ...
        self.entry.set_text("Enter the target Right Ascension:")
        self.entry.connect("activate",self.text_entered, self.entry)
    ...
    def text_entered(self, widget, entry):
    	enterdData = entry.get_text()
    	print "You entered: %s\n" % enterdData
